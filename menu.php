...
<div id="menuRight">
	...
	<div class="menuSection dropShadow">
		...
		<div class="menuContent dropShadow ui-corner-bottom">
			...
			<?php if ($permissionLevel >= $users->permissionIndex("Consiglio")) { ?>
				<a href="admin/userManagement">User Management</a><br />
			<?php } if ($permissionLevel >= $users->permissionIndex("Throne")) { ?>
				<a href="admin/scrubDatabase">Scrub Database</a><br />
				<?php } if ($permissionLevel >= $users->permissionIndex("Vigo")) { ?>
					<a href="admin/groupManagement">Group Management</a><br />
					<?php } if (isset($_SESSION['userId'])) { ?>
				<a href="changePassword">Change Password</a>
				<hr>
				<a href="ss/scan">Submit Scan</a><br />
			<?php } if ($permissionLevel >= $users->permissionIndex("Assistant")) { ?>
				<a href="ss/currentScans">Current Scans</a><br />
				<a href="ss/systemHistory">System History</a><br />
				<hr>
				<a href="ss/entitySearch">Entity Search</a><br />
			<?php } ?>
		</div>
	</div>
	<?php if(isset($_SESSION['userId'])){ ?>
	<div class="menuSection dropShadow">
		...
		<div class="menuContent dropShadow ui-corner-bottom">
			<?php if($permissionLevel >= $users->permissionIndex("Consiglio")){ ?>
			<a href="pm/systems">Systems Management</a><br/>
			<a href="pm/planets">Planets Management</a><br/>
			<?php } ?>
			<a href="pm/xml">Add Deposits XML</a><br/>
	</div>
</div>
<?php } ?>
