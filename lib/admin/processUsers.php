<?php
    ...
    if (isset($_SESSION['userId'])) {
		...
		if (isset($_POST['mode']) == "update" && isset($_POST["actions"]) == "remove") {
		...
		} else if (isset($_POST['mode']) == "update" && isset($_POST["actions"]) == "transfer") {
		...
		} else if (isset($_POST['mode']) == 'update' && isset($_POST["actions"]) == 'group') {
			$errorOut = 0;
